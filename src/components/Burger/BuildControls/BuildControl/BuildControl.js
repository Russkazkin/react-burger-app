...
const buildControl = ({label, added, removed, disabled}) => (
  <div className={"flex justify-center items-center my-1.5 container mx-auto " + classes.BuildControl}>
    ...
    <button disabled={disabled} className="disabled:opacity-50 block p-1.5 mx-1.5 w-20 text-white border cursor-pointer focus:outline-none focus:outline-white bg-indigo-500 rounded-full hover:bg-indigo-300 hover:text-gray-700"
            onClick={removed}>Less
    </button>
